package others.history_version.v4;
...
public class Version4 {
    ...
    static final int CLIMBING_TIMES = 3000000;

    static int Row_Workpiece, Column_Machine;

    static final File FILE_INPUT  = new File("C:\\Users\\DOCTORY\\Desktop\\SA9.txt");
    static final File FILE_OUTPUT = new File("C:\\Users\\DOCTORY\\Desktop\\ANS9_.txt");
    ...
    private static void waitForThreads() {
        for (Thread thread : Version4.THREADS) {
